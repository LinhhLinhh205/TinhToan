...
namespace DangKyThongTin
{
    public partial class DangKyThongTin : System.Web.UI.Page
    {
        ...
        private void NhapDuLieu()
        {
            ...
            DdlTrinhDo.Items.Add(new ListItem("Đại học", "02"));
            DdlTrinhDo.Items.Add(new ListItem("TRung cấp", "03"));
